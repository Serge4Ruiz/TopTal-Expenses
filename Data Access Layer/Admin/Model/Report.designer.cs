...
namespace TopTal.Expenses.DataAccessLayer.Admin.Model
{
	public partial class Report : IModel
	{
		...
		public Report(DataLayer.MongoDB.Admin.Report report)
		{
			if (report == null)
				return;
			Soid = report.Id.ToString();
			SqlId = report.SqlId;
		...
		public DataLayer.MongoDB.Admin.Report ToModel()
		{
			var report = new DataLayer.MongoDB.Admin.Report();
