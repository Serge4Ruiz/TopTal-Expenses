...
namespace TopTal.Expenses.DataAccessLayer.Membership.Model
{
	public partial class Member : IModel
	{
		...
		public Member(DataLayer.MongoDB.Membership.Member member)
		{
			if (member == null)
				return;
			Soid = member.Id.ToString();
			SqlId = member.SqlId;
		...
		public DataLayer.MongoDB.Membership.Member ToModel()
		{
			var member = new DataLayer.MongoDB.Membership.Member();
