...
namespace TopTal.Expenses.ServiceLayer.Analytics.Model
{
	public partial class AccountUsage : IModel
	{
		...
		public AccountUsage(DataAccessLayer.Analytics.Model.AccountUsage accountUsage)
		{
		...
		public DataAccessLayer.Analytics.Model.AccountUsage ToModel()
		{
			var accountUsage = new DataAccessLayer.Analytics.Model.AccountUsage();
