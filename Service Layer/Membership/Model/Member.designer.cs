...
namespace TopTal.Expenses.ServiceLayer.Membership.Model
{
	public partial class Member : IModel
	{
		...
		public Member(DataAccessLayer.Membership.Model.Member member)
		{
			if (member == null)
				return;
			Soid = member.Soid;
		...
		public DataAccessLayer.Membership.Model.Member ToModel()
		{
			var member = new DataAccessLayer.Membership.Model.Member();
			member.Soid = Soid;
			member.SqlId = SqlId;
