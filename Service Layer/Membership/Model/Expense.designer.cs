...
namespace TopTal.Expenses.ServiceLayer.Membership.Model
{
	public partial class Expense : IModel
	{
		...
		public Expense(DataAccessLayer.Membership.Model.Expense expense)
		{
			if (expense == null)
				return;
			Soid = expense.Soid;
		...
		public DataAccessLayer.Membership.Model.Expense ToModel()
		{
			var expense = new DataAccessLayer.Membership.Model.Expense();
			expense.Soid = Soid;
			expense.SqlId = SqlId;
