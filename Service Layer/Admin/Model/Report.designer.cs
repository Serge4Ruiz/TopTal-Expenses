...
namespace TopTal.Expenses.ServiceLayer.Admin.Model
{
	public partial class Report : IModel
	{
		...
		public Report(DataAccessLayer.Admin.Model.Report report)
		{
			if (report == null)
				return;
			Soid = report.Soid;
		...
		public DataAccessLayer.Admin.Model.Report ToModel()
		{
			var report = new DataAccessLayer.Admin.Model.Report();
			report.Soid = Soid;
			report.SqlId = SqlId;
