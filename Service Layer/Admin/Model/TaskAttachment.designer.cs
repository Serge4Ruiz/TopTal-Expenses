...
namespace TopTal.Expenses.ServiceLayer.Admin.Model
{
	public partial class TaskAttachment : IModel
	{
		...
		public TaskAttachment(DataAccessLayer.Admin.Model.TaskAttachment taskAttachment)
		{
			if (taskAttachment == null)
				return;
			Soid = taskAttachment.Soid;
		...
		public DataAccessLayer.Admin.Model.TaskAttachment ToModel()
		{
			var taskAttachment = new DataAccessLayer.Admin.Model.TaskAttachment();
			taskAttachment.Soid = Soid;
