...
namespace TopTal.Expenses.ServiceLayer.Admin.Model
{
	public partial class ReportDefinition : IModel
	{
		...
		public ReportDefinition(DataAccessLayer.Admin.Model.ReportDefinition reportDefinition)
		{
			if (reportDefinition == null)
				return;
			Soid = reportDefinition.Soid;
		...
		public DataAccessLayer.Admin.Model.ReportDefinition ToModel()
		{
			var reportDefinition = new DataAccessLayer.Admin.Model.ReportDefinition();
			reportDefinition.Soid = Soid;
