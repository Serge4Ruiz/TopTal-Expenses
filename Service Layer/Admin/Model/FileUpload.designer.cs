...
namespace TopTal.Expenses.ServiceLayer.Admin.Model
{
	public partial class FileUpload : IModel
	{
		...
		public FileUpload(DataAccessLayer.Admin.Model.FileUpload fileUpload)
		{
			if (fileUpload == null)
				return;
		...
		public DataAccessLayer.Admin.Model.FileUpload ToModel()
		{
			var fileUpload = new DataAccessLayer.Admin.Model.FileUpload();
