...
namespace TopTal.Expenses.BusinessLayer.Analytics.Model
{
	public partial class AccountLogin : IModel
	{
		...
		public AccountLogin(ServiceLayer.Analytics.Model.AccountLogin accountLogin)
		{
		...
		public ServiceLayer.Analytics.Model.AccountLogin ToModel()
		{
			var accountLogin = new ServiceLayer.Analytics.Model.AccountLogin();
