...
using TopTal.Expenses.ServiceLayer.Analytics;
...
namespace TopTal.Expenses.BusinessLayer.Analytics.Model
{
	public partial class AccountUsage : IModel
	{
		...
		public AccountUsage(ServiceLayer.Analytics.Model.AccountUsage accountUsage)
		{
			if (accountUsage == null)
				return;
			Soid = accountUsage.Soid;
		...
		public ServiceLayer.Analytics.Model.AccountUsage ToModel()
		{
			var accountUsage = new ServiceLayer.Analytics.Model.AccountUsage();
			accountUsage.Soid = Soid;
