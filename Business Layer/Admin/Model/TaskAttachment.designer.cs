...
namespace TopTal.Expenses.BusinessLayer.Admin.Model
{
	public partial class TaskAttachment : IModel
	{
		...
		public TaskAttachment(ServiceLayer.Admin.Model.TaskAttachment taskAttachment)
		{
		...
		public ServiceLayer.Admin.Model.TaskAttachment ToModel()
		{
			var taskAttachment = new ServiceLayer.Admin.Model.TaskAttachment();
