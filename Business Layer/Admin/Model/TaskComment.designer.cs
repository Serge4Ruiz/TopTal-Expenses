...
namespace TopTal.Expenses.BusinessLayer.Admin.Model
{
	public partial class TaskComment : IModel
	{
		...
		public TaskComment(ServiceLayer.Admin.Model.TaskComment taskComment)
		{
			if (taskComment == null)
				return;
		...
		public ServiceLayer.Admin.Model.TaskComment ToModel()
		{
			var taskComment = new ServiceLayer.Admin.Model.TaskComment();
