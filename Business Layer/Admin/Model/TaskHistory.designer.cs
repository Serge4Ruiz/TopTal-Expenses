...
namespace TopTal.Expenses.BusinessLayer.Admin.Model
{
	public partial class TaskHistory : IModel
	{
		...
		public TaskHistory(ServiceLayer.Admin.Model.TaskHistory taskHistory)
		{
			if (taskHistory == null)
				return;
		...
		public ServiceLayer.Admin.Model.TaskHistory ToModel()
		{
			var taskHistory = new ServiceLayer.Admin.Model.TaskHistory();
