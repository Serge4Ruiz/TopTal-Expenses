...
namespace TopTal.Expenses.BusinessLayer.Admin.Model
{
	public partial class ReportDefinition : IModel
	{
		...
		public ReportDefinition(ServiceLayer.Admin.Model.ReportDefinition reportDefinition)
		{
		...
		public ServiceLayer.Admin.Model.ReportDefinition ToModel()
		{
			var reportDefinition = new ServiceLayer.Admin.Model.ReportDefinition();
