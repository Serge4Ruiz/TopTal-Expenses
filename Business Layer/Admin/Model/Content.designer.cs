...
namespace TopTal.Expenses.BusinessLayer.Admin.Model
{
	public partial class Content : IModel
	{
		...
		public Content(ServiceLayer.Admin.Model.Content content)
		{
			if (content == null)
				return;
			Soid = content.Soid;
		...
		public ServiceLayer.Admin.Model.Content ToModel()
		{
			var content = new ServiceLayer.Admin.Model.Content();
			content.Soid = Soid;
			content.SqlId = SqlId;
